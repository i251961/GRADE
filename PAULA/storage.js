...
const STORAGE_KEY = "planejadorGraduacao_pedagogia20G";
...
const CHAVES_ANTIGAS = [];  // curso novo, sem versao anterior para migrar
...
function _migrarChavesAntigasSeExistirem() {
  if (!CHAVES_ANTIGAS.length) return null; // este curso não tem versão anterior a migrar
  try {
